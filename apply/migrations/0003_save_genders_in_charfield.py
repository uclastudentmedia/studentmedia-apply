...
# Data migration
# Created a temporary charField to convert existing users' genders
# into charfields
...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        for user in orm.Profile.objects.all():
            if user.gender == 'M':
                user.gender_fill_in_the_blank = "Male"
            else:
                user.gender_fill_in_the_blank = "Female"
            user.save()
    ...
    models = {
        ...
        u'apply.profile': {
            ...
            'gender_fill_in_the_blank': ('django.db.models.fields.CharField', [], {'max_length': '30', 'null': 'True'}),
