...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Profile.gender_fill_in_the_blank'
        db.delete_column(u'apply_profile', 'gender_fill_in_the_blank')


    def backwards(self, orm):
        # Adding field 'Profile.gender_fill_in_the_blank'
        db.add_column(u'apply_profile', 'gender_fill_in_the_blank',
                      self.gf('django.db.models.fields.CharField')(default='blank', max_length=30),
                      keep_default=False)
